<?php
define("Memcache_SESSION_STARTED",      1);
define("Memcache_SESSION_CONTINUED",    2);
echo 333;exit;
/**
 +------------------------------------------------------------------------------
 * Memcache操作管理类
...
class Memcache_session {
    ...
    public $port = 11211;        //端口号
	public $host = 'localhost';  //主机
	public $status = true;       //状态
	public $model;               //模型
    ...
    public function __construct() {
		...
		$result = $Memcache->connect('192.168.2.114', 11211);
		$this->status = $result;
    }
