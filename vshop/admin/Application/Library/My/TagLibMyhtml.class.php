...
class TagLibMyhtml extends TagLib{
    ...
    public function _imageBtn($attr) {
        ...
        if(!empty($name)) {
        	...
        	$parseStr   = '<a href="__CONTROLLER__/'.$click.'" class="l-btn l-btn-small l-btn-plain" group="" id="'.$id.'"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">'.$value.'</span><span class="l-btn-icon icon-restore">&nbsp;</span></span>';
        }
