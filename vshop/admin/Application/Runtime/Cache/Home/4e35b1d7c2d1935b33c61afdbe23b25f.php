...
var URL = '/guoji/vshop/ADMIN2/index.php/Shoplist';
...
<script>
 function uponline(){
   window.location.href = "/guoji/vshop/ADMIN2/index.php/Shoplist/uponline";
 }

 function she_uponline(){
   window.location.href = "/guoji/vshop/ADMIN2/index.php/Shoplist/she_uponline";
 }

 function look(id){
   var url = '/guoji/vshop/ADMIN2/index.php/Shoplist/look/id/'+id;
   window.open(url) 
 }


 function addold(){
   window.location.href = "/guoji/vshop/ADMIN2/index.php/Shoplist/addold";
 }

 function upshowtime(id){
   var url = '/guoji/vshop/ADMIN2/index.php/Shoplist/upshowtime/id/'+id;
   window.open(url);
 }
</script>
<!-- 内容区 -->
<div class="content">
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/guoji/vshop/ADMIN2/index.php/Shoplist">
				...
				<table cellspacing="0" cellpadding="0"><tbody>
				  ...
				  <div class="datagrid-view">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr  class="datagrid-row <?php if(($mod) == "1"): ?>datagrid-row-alt<?php endif; ?>">
					  ...
					  <td style="text-align:left;height:auto;padding-left:8px;"><a href="/guoji/vshop/ADMIN2/index.php/Shoplist/edit/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></a></td>
					  <td><?php echo ($vo["type_name"]); ?></td>
					  <td>
					  <?php echo ($vo["canyurenshu"]); ?>/<?php echo ($vo["zongrenshu"]); ?>
					  </td>
					  <td>
					  <?php echo ($vo["yunjiage"]); ?>
					  </td>
					  <td>
					  <?php echo ($vo["qishu"]); ?>/<?php echo ($vo["maxqishu"]); ?>
					  </td>
					  <td>
					  ...
					  <a href="/guoji/vshop/ADMIN2/index.php/Shoplist/album/sourceid/<?php echo ($vo["id"]); ?>">图片编辑</a>&nbsp;
					  <a href="/guoji/vshop/ADMIN2/index.php/Shoplist/before/id/<?php echo ($vo["id"]); ?>">查看往期</a>&nbsp;
					  </td>
