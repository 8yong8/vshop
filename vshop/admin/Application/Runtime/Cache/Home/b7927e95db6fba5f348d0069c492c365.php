...
<div class="content">
<div class="title">编辑数据 [ <A HREF="/guoji/vshop/admin2/index.php/Article">返回列表</A> ]  [ <A HREF="/guoji/vshop/admin2/index.php/Article/index/cid/<?php echo ($vo['cid']); ?>">返回分类列表</A> ]</div>
<FORM METHOD=POST id="form1" action="/guoji/vshop/admin2/index.php/Article/edit?<?php echo time(); ?>" enctype="multipart/form-data">
...
<TR>
	...
	<TD class="tLeft" ><input name="source" type="text" id="f_source" style="width:160px;" value="<?php echo ($vo['source']); ?>"/> &nbsp;作 者：<input name="author" type="text" id="author" style="width:120px;"  value="<?php echo ($vo['author']); ?>"/></TD>
</TR>
...
<TR>
	...
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire" NAME="pv_count" value="<?php echo ($vo['pv_count']); ?>"></TD>
</TR>
...
<script>
  function showhide(){
	...
	<div>
		...
		<div id="show1">
		<?php if(($vo["lit_pic"]) != ""): ?><img src="<?php echo ($vo["lit_pic"]); ?>" width="260px"><?php endif; ?>
		</div>
	</div>
	</TD>
</TR>
...
<TR>
	...
	<TD class="tLeft">
	<div>
		<input type="file" id="lit_pic2" name="lit_pic2" onchange="yulan(this,'show2')"> 大小750*337
		<div id="show2">
