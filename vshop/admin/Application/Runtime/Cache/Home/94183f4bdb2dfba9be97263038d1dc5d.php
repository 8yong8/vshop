...
<div class="content">
<div class="title"> 新增[ <a href="/git/vshop/admin/index.php/Position">返回列表</a> ] [<a href="/git/vshop/admin/index.php/Position/index/pid/<?php echo ($vo["pid"]); ?>">返回上级</a> ]</div>
<form method='post'  id="form1" action='/git/vshop/admin/index.php/Position/edit?<?php echo time(); ?>' enctype="multipart/form-data">
...
<TR>
	...
	<option value="0" <?php if(($vo["pid"]) == "0"): ?>selected<?php endif; ?> >
	请选择</option>
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type[id]); ?>" <?php if(($vo["pid"]) == $type[id]): ?>selected<?php endif; ?> >
...
<tr>
	...
	<td class="tLeft"><TEXTAREA class="large bLeft" name="info"  rows="5" cols="57"><?php echo ($vo["info"]); ?></textarea></td>
</tr>
<tr>
	<td></td>
	<td><div style="width:85%;margin:5px">
