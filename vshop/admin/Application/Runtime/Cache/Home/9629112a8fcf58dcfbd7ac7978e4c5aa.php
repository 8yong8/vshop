...
<div class="content">
<div class="title"> <?php if(($level) == "1"): ?>项目<?php endif; if(($level) == "2"): ?>模块<?php endif; if(($level) == "3"): ?>操作<?php endif; ?>排序  [ <a href="/guoji/vshop/ADMIN2/index.php/Role">返回列表</a> ]</div>
<script language="JavaScript">
function allSelect(){
...
function saveAccess(){
  sendForm('form1','/guoji/vshop/ADMIN2/index.php/Role/setApp/');
}
...
<tbody><tr><td height="5" colspan="3" class="topTd"></td></tr>
<tr><th class="tCenter">应用授权 | <a href="/guoji/vshop/ADMIN2/index.php/Role/module/groupId/2">模块授权</a> | <a href="/guoji/vshop/ADMIN2/index.php/Role/action/groupId/2">操作授权</a>
</th></tr>
