...
<script>
 function cache(){
   location.href = "/git/vshop/admin/index.php/PaymentConfig/GiveCache";
 }

 function add(){
   location.href = "/git/vshop/admin/index.php/PaymentConfig/ali_add";
 }
</script>
...
<script type="text/javascript" src="/git/vshop/admin/Public/js/EasyUI/hd_default_config.js"></script>
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/git/vshop/admin/index.php/PaymentConfig">
