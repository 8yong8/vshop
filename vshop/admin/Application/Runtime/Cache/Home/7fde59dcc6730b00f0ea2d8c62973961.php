...
var URL = '/guoji/vshop/admin2/index.php/Class';
...
<script>
 function GiveCache(){
   location.href = "/guoji/vshop/admin2/index.php/Class/giveCache";
 }

  function typeset(id){
    window.location.href = "/guoji/vshop/admin2/index.php/Class/typeset/id/"+id;
  }
</script>
<!-- 内容区 -->
<div class="content">
