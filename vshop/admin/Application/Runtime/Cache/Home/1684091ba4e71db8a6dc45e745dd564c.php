...
<div class="content">
<div class="title">商品图库 [ <a href="/git/vshop/admin/index.php/Product">返回列表</a> ] [ <a href="/git/vshop/admin/index.php/Product/edit/id/<?php echo ($vo["id"]); ?>">返回商品</a> ]</div>
<form method='post' id="form1" action="/git/vshop/admin/index.php/Product/upablum/" enctype="multipart/form-data">
...
<tr>
	...
	<img src="/git/vshop/admin/Public/images/ico_cuo.png" onclick="delpic('<?php echo ($pic["picid"]); ?>')" style="cursor:pointer" alt="删除按钮">
	</span>
