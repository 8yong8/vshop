...
<div class="content">
<div class="title">编辑组 [ <a href="/guoji/vshop/ADMIN2/index.php/Role">返回列表</a> ]</div>
<div id="result" class="result none"></div>
<form method='post'  id="form1" action="/guoji/vshop/ADMIN2/index.php/Role/edit?<?php echo time(); ?>">
