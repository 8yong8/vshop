...
<script type="text/javascript" src="/guoji/vshop/ADMIN2/Public/js/apply/order.js"></script>
	...
	<div class="goods mt10">
		<FORM METHOD=get ACTION="/guoji/vshop/ADMIN2/index.php/Order">
		<div class="guanli">
		...
		<TR>
			...
			<TD><INPUT TYPE="text" NAME="order_id" class="medium" value="<?php echo ($order_id); ?>"></TD>

			<TD class="tRight">订单状态：</TD>
			<TD>
			<SELECT NAME="status">
				<OPTION VALUE="" <?php if(($_GET['status']) == ""): ?>SELECTED<?php endif; ?>>全部</OPTION>
				<OPTION VALUE="0" <?php if(($_GET['status']) == "0"): ?>SELECTED<?php endif; ?>>未确认</OPTION>
				<OPTION VALUE="1" <?php if(($_GET['status']) == "1"): ?>SELECTED<?php endif; ?>>确认</OPTION>
				<OPTION VALUE="2" <?php if(($_GET['status']) == "2"): ?>SELECTED<?php endif; ?>>完成交易</OPTION>
			</SELECT>
			</TD>
			...
			<SELECT NAME="pay_status">
				<OPTION VALUE="" <?php if(($_GET['pay_status']) == ""): ?>SELECTED<?php endif; ?>>全部</OPTION>
				<OPTION VALUE="0" <?php if(($_GET['pay_status']) == "0"): ?>SELECTED<?php endif; ?>>未支付</OPTION>
				<OPTION VALUE="1" <?php if(($_GET['pay_status']) == "1"): ?>SELECTED<?php endif; ?>>已支付</OPTION>
			</SELECT>
			</TD>
			...
			<SELECT NAME="delivery_status">
				<OPTION VALUE="" <?php if(($_GET['pay_status']) == ""): ?>SELECTED<?php endif; ?>>全部</OPTION>
				<OPTION VALUE="0" <?php if(($_GET['pay_status']) == "0"): ?>SELECTED<?php endif; ?>>未发货</OPTION>
				<OPTION VALUE="1" <?php if(($_GET['pay_status']) == "1"): ?>SELECTED<?php endif; ?>>已发货</OPTION>
			</SELECT>
			</TD>
				...
				<table cellspacing="0" cellpadding="0"><tbody>
				  ...
				  <div class="datagrid-view">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="datagrid-row <?php if(($mod) == "1"): ?>datagrid-row-alt<?php endif; ?>">
						<td><input type="checkbox" value="<?php echo ($vo["id"]); ?>" name="key"></td>
						<td><?php echo ($vo["id"]); ?></td>
						<td><?php echo ($vo["order_sn"]); ?></td>
						<td><?php echo (rs($vo["type"],'1#商城@2#云购@3#兑换商品')); ?></td>
						<td><?php echo (rs($vo["payment_mode"],'1#在线支付#blue@2#货到付款#blue')); ?>：<?php echo ($vo["payment_company"]); ?> <?php echo ($vo["payment_channel"]); ?></td>
						<td>
						<?php echo ($vo["actual_paid"]); ?>
						<?php if(($vo["is_refund"]) == "1"): ?>/<?php echo ($vo["actual_refund"]); endif; ?>
						</td>
						...
						<!--<td><strong><?php echo (rs($vo["delivery_status"],'0#未发货#purple@1#已发货@2#已收货#blue')); ?></strong></td>-->
						<td>
						<a href="/guoji/vshop/ADMIN2/index.php/Order/edit/id/<?php echo ($vo["id"]); ?>">详情查看</a>
						<!--
						<a href="/guoji/vshop/ADMIN2/index.php/Order/look/id/<?php echo ($vo["id"]); ?>" target="_blank">详情查看</a>
						-->
						&nbsp; </td>
