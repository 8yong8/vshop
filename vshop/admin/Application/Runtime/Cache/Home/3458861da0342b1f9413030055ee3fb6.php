...
var URL = '/git/vshop/admin/index.php/Product';
...
function album( sourceid ){
  window.location.href = "/git/vshop/admin/index.php/Product/album/sourceid/"+sourceid;
}

function look(id){
    window.location.href="/git/vshop/admin/index.php/Auction_log/index/aid/"+id;
}

function runguo(action){
    window.location.href="/git/vshop/admin/index.php/Product/"+action;
} 
var pid;
function Timing(id){
  pid = id;
...
function auction(pid){
  //alert(pid);
  window.location.href="/git/vshop/admin/index.php/Auction/add/pid/"+pid;
}

function add_attr(id){
  window.location.href="/git/vshop/admin/index.php/Product/add_attr/id/"+id;
}
...
function prom(s){
  ...
  window.location.href="/git/vshop/admin/index.php/Product/prom/id/"+keyValue+'/s/'+s;
}
</script>
	...
	<div class="goods mt10">
		<div class="guanli">
		<FORM METHOD=get ACTION="/git/vshop/admin/index.php/Product">
	...
	<dl class="mt10">
		<dt><p>
			<a href="/git/vshop/admin/index.php?m=Product&a=index" <?php if(($status) == ""): ?>class="hover"<?php endif; ?>>全部商品</a>
			<a href="/git/vshop/admin/index.php?m=Product&a=index&status=0" <?php if(($status) == "0"): ?>class="hover"<?php endif; ?>>下架商品</a>
			<!--
			<a href="/git/vshop/admin/index.php?m=Product&a=index&status=2">缺货商品</a>
			<a href="/git/vshop/admin/index.php?m=Product&a=index&status=3">库存警告</a>
			<a href="/git/vshop/admin/index.php?m=Product&a=index&status=4">回收站</a></p>
			-->
		</dt>
				...
				<table cellspacing="0" cellpadding="0"><tbody>
				  ...
				  <div class="datagrid-view">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="datagrid-row <?php if(($mod) == "1"): ?>datagrid-row-alt<?php endif; ?>"  >
					  ...
					  <td><?php echo (rs($vo["is_pm"],'0#否@1#是#red')); ?> 【<a href="/git/vshop/admin/index.php/Product/prom_list/prom_id/<?php echo ($vo["id"]); ?>" target="_blank">查看</a>】 </td>
					  <td>
					  ...
					  <a href="/git/vshop/admin/index.php/Product/album/sourceid/<?php echo ($vo["id"]); ?>">图片编辑</a>&nbsp;
					  </td>
