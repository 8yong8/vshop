...
var URL = '/guoji/vshop/admin2/index.php/Product_category';
...
<div class="content">
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/guoji/vshop/admin2/index.php/Product_category">
	  <div class="guanli" style="/*border:1px red solid;*/">
		<TABLE cellpadding="1" cellspacing="2" width="100%">
		<TR>
			<TD class="tRight">分类名：</TD>
			<TD><INPUT TYPE="text" NAME="name" class="large " value="<?php echo ($name); ?>"></TD>
			<TD class="tRight">可用：</TD>
			<TD>
			<SELECT name="channel">
			  <OPTION value="">全部</OPTION>
			  <OPTION value="商城" <?php if(($_GET['channel']) == "商城"): ?>SELECTED<?php endif; ?>>商城</OPTION>
			  <OPTION value="云购" <?php if(($_GET['channel']) == "云购"): ?>SELECTED<?php endif; ?>>云购</OPTION>
			</SELECT>
			</TD>
			<TD>
