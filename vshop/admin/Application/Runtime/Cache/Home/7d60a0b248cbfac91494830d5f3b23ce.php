...
var URL = '/guoji/vshop/ADMIN2/index.php/Coupon';
...
<script>
function look(coupon_id){
  window.open('/guoji/vshop/ADMIN2/index.php/Member_coupon/index/coupon_id/'+coupon_id);  
}
</script>
