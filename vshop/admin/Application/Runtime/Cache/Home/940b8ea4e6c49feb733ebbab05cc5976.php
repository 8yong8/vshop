...
<div class="content">
    ...
    <dl class="tishi">
        ...
        <dd>
            <h3><?php echo (nl2br(htmlspecialchars($error))); ?></h3>
				<p>
                	<!--<a href="<?php echo ($jumpUrl); ?>">如果您的浏览器没有自动跳转，请点击这里</a>-->
					您可以选择 [ <A HREF="<?php echo ($FCS["SERVER"]["PHP_SELF"]); ?>">重试</A> ] [ <A HREF="javascript:history.back()">返回</A> ] 或者 [ <A HREF="/git/vshop/admin/index.php">回到首页</A> ]
                </p>
        </dd>
    </dl>
<script language="javascript">
