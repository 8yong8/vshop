...
<div class="content">
<div class="title">添加数据 [ <A HREF="/gh/vshop/admin/index.php/Article">返回列表</A> ]</div>
<FORM METHOD=POST id="form1" action="/gh/vshop/admin/index.php/Article/add?<?php echo time(); ?>" enctype="multipart/form-data">
...
<TR>
	...
	<TD class="tLeft"><font color="red">	<input type="button" onclick="window.open('/gh/vshop/admin/index.php/Article/ajax_upimg/jsdo/insertnrjson/hash/<?php echo ($hash); ?>')" class="button" value="上传图片"></font></TD>
</TR>
-->
<TR>
    <TD class="tRight tTop">内 容：</TD>
	<TD class="tLeft" colspan="2">
	<textarea id="content" style="width:650px;height:345px" name="content" ><?php echo ($vo["content"]); ?></textarea><script type="text/javascript" src="/gh/vshop/admin/Public/Js/KindEditor/kindeditor-min.js"></script><script>KindEditor.create('#content', {uploadJson : '/gh/vshop/admin/index.php/Attachment/editer_upload',fileManagerJson : '/gh/vshop/admin/index.php/Attachment/editer_manager',allowFileManager : false,items:['source','title', 'fontname', 'fontsize', '|', 'link', 'unlink','|', 'forecolor', 'bgcolor', 'bold','italic', 'underline', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright','justifyfull', '|', 'image', 'multiimage', 'emoticons','baidumap']});</script>
	</TD>
</TR>
