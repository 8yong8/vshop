...
<div class="content">
<div class="title">数据修改[ <A HREF="/guoji/vshop/admin2/index.php/Class">返回列表</A> ]</div>
<FORM METHOD=POST id="form1" action="/guoji/vshop/admin2/index.php/Class/edit?<?php echo time(); ?>">
...
<TR>
	...
	<TD class="tLeft" ><INPUT TYPE="text" class="medium bLeftRequire"  check='Require' warning="标题不能为空" NAME="name" value="<?php echo ($vo["name"]); ?>"></TD>
</TR>

<TR>
	<TD class="tRight" >排序：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="medium bLeftRequire" NAME="sort" value="<?php echo ($vo["sort"]); ?>"></TD>
</TR>
