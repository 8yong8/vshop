...
<div class="content">
<div class="title">数据修改[ <A HREF="/git/vshop/admin/index.php/Class">返回列表</A> ]</div>
<FORM METHOD=POST id="form1" action="/git/vshop/admin/index.php/Class/edit?<?php echo time(); ?>">
