...
var URL = '/guoji/vshop/ADMIN2/index.php/Shipping';
...
<script>
 function is_select(id){
	$.ajax({
	  type:'POST',
	  dataType:'json',
	  url:'/guoji/vshop/ADMIN2/index.php/Shipping/is_select',
	  data:'id='+id,
