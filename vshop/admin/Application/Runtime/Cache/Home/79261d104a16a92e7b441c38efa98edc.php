...
<div class="content">
<div class="title">API修改[ <A HREF="/guoji/vshop/admin2/index.php/Api">返回列表</A> ]</div>
<script>
function ResetAppKey(){
  $('#appkey').val(randomString(32));
}
</script>
<FORM METHOD=POST id="form1" action="/guoji/vshop/admin2/index.php/Api/edit/">
...
<TR>
	...
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire" NAME="name" value="<?php echo ($vo["name"]); ?>"></TD>
</TR>

<TR>
	<TD class="tRight" >AppId：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire" NAME="appid" value="<?php echo ($vo["appid"]); ?>"></TD>
</TR>

<TR>
	<TD class="tRight" >AppKey：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire" NAME="appkey" id="appkey" value="<?php echo ($vo["appkey"]); ?>">
	<input type="button" value="生成随机数" onclick="ResetAppKey()" class="button" style="height:25px">
	</TD>
</TR>

<TR>
	<TD class="tRight" >网关地址：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire" NAME="gateway" id="gateway" value="<?php echo ($vo["gateway"]); ?>">
	</TD>
</TR>
