...
<div class="content">
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/guoji/vshop/ADMIN2/index.php/Attribute">
	  <div class="guanli">
		...
		<TR>
			...
			<SELECT NAME="cat_id">
			  ...
			  <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cat["id"]); ?>" <?php if(($_GET['cat_id']) == $cat["id"]): ?>selected<?php endif; ?>><?php echo ($cat["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</SELECT>
			</TD>
		...
		<dd>
			<div class="login mt10" style="border: none;">
				...
				<table cellspacing="0" cellpadding="0"><tbody>
				  <tr>
					<td>
					  <a href="javascript:add(<?php echo ($_GET['cat_id']); ?>);" class="l-btn l-btn-small l-btn-plain" group="" id="add"><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text" style="impBtn hMargin fLeft shadow">添加</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a>
					</td>
