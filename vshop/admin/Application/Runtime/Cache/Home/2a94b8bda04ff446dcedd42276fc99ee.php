...
var URL = '/gh/vshop/admin/index.php/Index';
    ...
    <dl class="box fr mt10">
        ...
        <dd>
            <ul class="odd2">
                ...
                <li><span><a href="/gh/vshop/admin/index.php?c=user&c=member_consult&a=lists" title="商品咨询总数"><?php echo $order_count['consult_total'] ?></a> 条</span>商品咨询总数：</li>
                <li><span><a href="/gh/vshop/admin/index.php?c=user&c=member_consult&a=lists" title="未处理咨询总数"><i><?php echo $order_count['consult_reply'] ?></i></a> 条</span>未处理咨询总数：</li>
