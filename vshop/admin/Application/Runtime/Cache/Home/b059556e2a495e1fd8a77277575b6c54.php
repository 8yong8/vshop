...
<div class="content">
<div class="title">编辑支付宝支付[ <A HREF="/git/vshop/admin/index.php/PaymentConfig">返回列表</A> ]</div>
...
<TR>
	...
	<TD class="tLeft" >
	<select name="pay_name" id="pay_name" onchange="rungo();">
	 <option value="支付宝" selected>支付宝</option>
	</select>
	<a href="/git/vshop/admin/index.php/PaymentConfig/wx_add">切换到微信支付</a>
	<a href="/git/vshop/admin/index.php/PaymentConfig/wxapp_add">切换到微信APP支付</a>
	</TD>
</TR>

<TR>
	<TD class="tRight" >账户昵称：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire"  NAME="account_nickname" value="<?php echo ($vo["account_nickname"]); ?>"> 用以区别不同账号</TD>
</TR>

<TR>
	<TD class="tRight" >合作身份者id：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire"  NAME="partner" value="<?php echo ($vo["partner"]); ?>"> 合作身份者id，以2088开头的16位纯数字</TD>
</TR>

<TR>
	<TD class="tRight" >key：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire"  NAME="key" value="<?php echo ($vo["key"]); ?>"> 安全检验码，以数字和字母组成的32位字符</TD>
</TR>

<TR>
	<TD class="tRight" >账号：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire"  NAME="seller_email" value="<?php echo ($vo["seller_email"]); ?>"></TD>
</TR>
