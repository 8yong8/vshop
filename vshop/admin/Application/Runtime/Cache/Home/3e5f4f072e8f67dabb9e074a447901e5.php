...
var URL = '/guoji/vshop/ADMIN2/index.php/Flag_module';
...
<div class="content">
	...
	<div class="guanli">
	    <FORM METHOD="GET" ACTION="/guoji/vshop/ADMIN2/index.php/Flag_module/">
		<TABLE cellpadding="1" cellspacing="2" width="100%">
		<TR>
			<TD class="tRight">模型：</TD>
			<TD>
			<select name="moudel_name" id="moudel_name">
			  <option value="">模块选择</option>
			  <?php if(is_array($nodes)): $i = 0; $__LIST__ = $nodes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><option value="<?php echo ($node["name"]); ?>" <?php if(($_GET['moudel_name']) == $node["name"]): ?>selected
			  ="selected"<?php endif; ?> ><?php echo ($node["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</TD>
			...
			<select name="fid">
			  ...
			  <?php if(is_array($flags)): $i = 0; $__LIST__ = $flags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$flag): $mod = ($i % 2 );++$i;?><option value="<?php echo ($flag["id"]); ?>" <?php if(($_GET['fid']) == $flag["id"]): ?>selected
			  ="selected"<?php endif; ?> ><?php echo ($flag["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			</TD>
			<TD>
