				...
				<table cellspacing="0" cellpadding="0"><tbody>
				  ...
				  <div class="datagrid-view">
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="datagrid-row <?php if(($mod) == "1"): ?>datagrid-row-alt<?php endif; ?>">
					  ...
					  <td><a href="/git/vshop/admin/index.php/Position/index/pid/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></td>
					  ...
					  <td style="text-align:left;height:auto;">
						...
						&nbsp;<a href="/git/vshop/admin/index.php/Position/index/pid/<?php echo ($vo["id"]); ?>">子节点
						&nbsp;<a href="/git/vshop/admin/index.php/Position/substance/id/<?php echo ($vo["id"]); ?>" target="_balnk">内容查看</a>&nbsp;
						<a href="/git/vshop/admin/index.php/Position/sub_add/id/<?php echo ($vo["id"]); ?>" target="_balnk">添加内容</a>&nbsp;
					  </td>
