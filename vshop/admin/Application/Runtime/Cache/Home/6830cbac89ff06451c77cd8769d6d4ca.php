...
var URL = '/guoji/vshop/ADMIN2/index.php/User';
...
function update_menu(uid){
  window.location.href = '/guoji/vshop/ADMIN2/index.php/User/update_menu/uid/'+uid;
}

function access_view(uid){
  $.ajax({
	type:'POST',
	url:'/guoji/vshop/ADMIN2/index.php/User/access_view/',
	data:'uid='+uid,
...
<div class="content">
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/guoji/vshop/ADMIN2/index.php/User">
	  <div class="guanli">
