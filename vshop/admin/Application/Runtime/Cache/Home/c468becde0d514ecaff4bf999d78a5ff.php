...
var URL = '/guoji/vshop/admin2/index.php/Flag';
...
<div class="content">
<div class="title">属性修改[ <A HREF="/guoji/vshop/admin2/index.php/Flag">返回列表</A> ]</div>

<FORM METHOD=POST id="form1" action="/guoji/vshop/admin2/index.php/Flag/edit/">
...
<TR>
	...
	<TD class="tLeft" ><INPUT TYPE="text" class="large bLeftRequire"  check='Require' warning="标题不能为空" NAME="name" value="<?php echo ($vo["name"]); ?>"></TD>
</TR>
<!--
<TR>
	<TD class="tRight" >保留条数：</TD>
	<TD class="tLeft" ><INPUT TYPE="text" class="medium bLeftRequire"  NAME="keep" value="<?php echo ($vo["keep"]); ?>"></TD>
</TR>
-->
<TR>
