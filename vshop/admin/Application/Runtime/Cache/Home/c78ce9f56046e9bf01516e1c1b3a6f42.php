...
var URL = '/guoji/vshop/ADMIN2/index.php/ProductType';
...
<script>
 function lists(id){
   window.location.href = "/guoji/vshop/ADMIN2/index.php/Attribute/index/cat_id/"+id;
 }
 ...
 function is_select(id){
	jQuery.ajax({
	  type:'POST',
	  dataType:'json',
	  url:'/guoji/vshop/ADMIN2/index.php/ProductType/is_select',
	  data:'id='+id,
...
<div class="content">
	...
	<div class="goods mt10">
	  <FORM METHOD=get ACTION="/guoji/vshop/ADMIN2/index.php/ProductType">
	  <div class="guanli">
		<TABLE cellpadding="1" cellspacing="2" width="100%">
		<TR>
			<TD class="tRight">名称：</TD>
			<TD><INPUT TYPE="text" NAME="attr_name" class="small" value="<?php echo ($attr_name); ?>"></TD>
