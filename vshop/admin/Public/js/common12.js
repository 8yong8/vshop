...
function cache(){
	window.location.href = URL+'/GiveCache';  
}
//禁用
function forbid(id){
	var keyValue;
...
function upyunPicUpload(domid,width,height){
	...
	art.dialog.open(APP+'?&m=Upyun&a=dialog_upload&width='+width+'&height='+height,{lock:true,title:'上传图片',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.45});
}
