...
<link type="text/css" href="/guoji/vshop/Wap/Public/css/imgbox.css" rel="stylesheet"/>

<script type="text/javascript" src="/guoji/vshop/Wap/Public/js/jquery.event.drag-1.5.min.js"></script>
<script type="text/javascript" src="/guoji/vshop/Wap/Public/js/jquery.touchSlider.js"></script>
...
function sent(){
	if(type==1){
		$.ajax({
			...
			dataType:'json',
			type: "POST",
			url:'/guoji/vshop/Wap/index.php/Cart/add',
...
<?php if(($data) != ""): ?><script type="text/javascript" src="/guoji/vshop/Wap/Public/js/apply/sku.js"></script><?php endif; ?>
...
<div class="menu2">
   <a class="back2" href="/guoji/vshop/Wap/index.php/Product/lists"><img src="/guoji/vshop/Wap/Public/images/menu_back.png"></a>
...
<div class="goods_info">
   ...
   <div class="others">
      <ul>
         <li><a class="tv" href="/guoji/vshop/Wap/index.php/Product/imageText?id=<?php echo ($vo["id"]); ?>">图文详情</a></li>
         <li><a class="pj" href="/guoji/vshop/Wap/index.php/Feedback/index?product_id=<?php echo ($vo["id"]); ?>">商品评价</a></li>
      </ul>
   </div>
</div>
<!-- footer -->
