...
<div id="light" class="white_content"> 
    ...
    <div class="sx_list">
        ...
        <div class="sx_list_tj">
           ...
           <div class="sxtj_right">
              <ul>
				 <li><a href="/git/vshop/Wap/index.php/Product/list">取消搜索条件</a></li>
              </ul>
           </div>
        </div>
		<?php } ?>
...
<div class="menu">
   <a class="back" href="javascript:;" onclick="history.go(-1)"><img src="/git/vshop/Wap/Public/images/menu_back.png"></a>
   <div class="tit">商品列表</div>
   <a class="goods_sx" href="javascript:;" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'"><img src="/git/vshop/Wap/Public/images/menu_sx.png"></a>
</div>
<div class="shaixuan">
   <ul>
